  ...
  initialState: {
    byChannel: {
      general: [
        ...
        { id: 2, user: 'Alex', avatar: 'A', text: 'Hey everyone! Excited to be here 🚀', time: '9:05 AM' },
      ],
      random: [
        { id: 1, user: 'Sam', avatar: 'S', text: 'Anyone up for a code review session?', time: '10:00 AM' },
      ],
      'dev-talk': [
